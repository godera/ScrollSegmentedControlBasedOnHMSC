...
@property (nonatomic, strong) UIColor *textColorNormal; // default is [UIColor blackColor]
@property (nonatomic, strong) UIColor *textColorSelected; // default is [UIColor redColor]
